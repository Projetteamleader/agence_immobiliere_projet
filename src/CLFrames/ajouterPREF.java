...
public class ajouterPREF {
	...
	private void initialize() {
		...
		getNomPREF.setFont(new Font("Montserrat Medium", Font.PLAIN, 16));
		...
		getPrenomPREF.setFont(new Font("Montserrat Medium", Font.PLAIN, 16));
		...
		getTypePREF.setFont(new Font("Montserrat Medium", Font.PLAIN, 16));
		...
		getSurfacePREF.setFont(new Font("Montserrat Medium", Font.PLAIN, 16));
		...
		getLocalisationPREF.setFont(new Font("Montserrat Medium", Font.PLAIN, 16));
		...
		getPrixPREF.setFont(new Font("Montserrat Medium", Font.PLAIN, 16));
