...
public class ajouterINT {
	...
	private void initialize() {
		...
		lblDescriptionINT.setBounds(132, 251, 99, 19);
		frame.getContentPane().add(lblDescriptionINT);
		
		getNomINT = new JTextField();
		getNomINT.setFont(new Font("Tahoma", Font.PLAIN, 16));
		getNomINT.setColumns(10);
		getNomINT.setBounds(257, 73, 293, 36);
		frame.getContentPane().add(getNomINT);
		
		getPrenomINT = new JTextField();
		getPrenomINT.setFont(new Font("Tahoma", Font.PLAIN, 16));
		getPrenomINT.setColumns(10);
		getPrenomINT.setBounds(257, 128, 293, 36);
		frame.getContentPane().add(getPrenomINT);
		
		getDescriptionINT = new JTextField();
		getDescriptionINT.setFont(new Font("Tahoma", Font.PLAIN, 16));
		getDescriptionINT.setColumns(10);
		getDescriptionINT.setBounds(257, 243, 379, 81);
		...
		btnAjouter.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				String sql = "INSERT INTO Interaction VALUES ('"+Nom+"', '"+Prenom+"',to_date('"+Date+"','dd-mm-yyyy'), '"+Description+"')";				System.out.println(sql);
				try {
		...
		lblDateINT.setBounds(175, 193, 45, 19);
		frame.getContentPane().add(lblDateINT);
		
		getDateINT = new JTextField();
		getDateINT.setFont(new Font("Tahoma", Font.PLAIN, 16));
		getDateINT.setColumns(10);
		getDateINT.setBounds(257, 184, 293, 36);
